...
void mexFunction(int32_T nlhs, mxArray *plhs[], int32_T nrhs,
                 const mxArray *prhs[])
{
  mexAtExit(&sound_freq_atexit);
  sound_freq_initialize();
  unsafe_sound_freq_mexFunction(nlhs, plhs, nrhs, prhs);
                                   ...
                                   const mxArray *prhs[1])
{
  ...
  /* Call the function. */
  sound_freq_api(prhs[0], &outputs);
  /* Copy over outputs to the caller. */
  emlrtReturnArrays(1, &plhs[0], &outputs);
}

/*
 * File trailer for _coder_sound_freq_mex.c
 *
 * [EOF]
 */
